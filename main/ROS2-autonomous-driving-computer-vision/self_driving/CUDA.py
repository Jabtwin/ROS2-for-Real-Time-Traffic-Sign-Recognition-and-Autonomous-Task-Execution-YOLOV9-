...
class YOLOv9RealSense:
    def __init__(self, weights_path, device='cuda'):  # Set default device to 'cuda'
...
yolo = YOLOv9RealSense('/home/datnguyen/yolov9/best.pt', device='cuda')  # Ensure CUDA is used
